...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile Header */}
      <header className="md:hidden fixed top-0 left-0 right-0 bg-white shadow-sm border-b border-gray-200 z-40">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-0 z-50 md:z-auto md:static bg-white shadow-lg md:shadow-none border-r border-gray-200 transform transition-transform duration-300 ease-in-out ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 md:w-72 flex flex-col overflow-y-auto md:overflow-visible`}
      >
        {/* Mobile Close Button */}
      ...
      {/* Main Content */}
      <main className="md:ml-72 pt-16 md:pt-0 min-h-screen overflow-auto">
        <div className="p-4 md:p-8">
          ...
          {/* Content */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 min-h-[600px]">
            {renderContent()}
          </div>

          {/* Mobile Bottom Nav or Actions (if needed) */}
          {/* Add if additional mobile-specific elements are required */}
        </div>
      </main>
