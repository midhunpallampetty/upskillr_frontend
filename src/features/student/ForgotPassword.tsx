...
import LoadingButton from '../shared/components/UI/Loader'; 
...
const ForgotStudentPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsLoading(true);
      // 👇 Pass schoolName along with email
      const msg = await sendStudentResetLink(email, schoolName); 
      setMessage(msg);
      ...
      <div className="bg-white rounded-lg shadow-lg flex w-full max-w-4xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Enter your email to receive reset link ({schoolName})
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {timeLeft > 0 && (
              <p className="text-sm text-gray-600 mt-3">
                ...
                before sending another reset link.
              </p>
            )}
